...
export default function GraphsHome() {
  ...
  {/* 🩶 Background pattern for dashboard vibe */}
  ...
  {/* Hero / Header Section */}
  <section className="relative text-center pt-12 sm:pt-16 pb-8 sm:pb-10">
    {/* Glassy badges row */}
    <div className="flex justify-center flex-wrap gap-3 mb-5 sm:mb-6">
      <div className="px-4 py-1.5 rounded-full text-xs font-semibold 
                      bg-white/30 backdrop-blur-md border border-white/50 
                      text-indigo-800 shadow-[0_0_12px_rgba(79,70,229,0.25)]">
        Verified Public Data
      </div>
      <div className="px-4 py-1.5 rounded-full text-xs font-semibold 
                      bg-gradient-to-r from-amber-50/40 to-amber-100/30 
                      backdrop-blur-md border border-amber-200/60 
                      text-amber-700 shadow-[0_0_12px_rgba(245,158,11,0.25)]">
        Updated till 2025
      </div>
      <div className="px-4 py-1.5 rounded-full text-xs font-semibold 
                      bg-gradient-to-r from-emerald-50/40 to-teal-100/30 
                      backdrop-blur-md border border-emerald-200/60 
                      text-emerald-700 shadow-[0_0_12px_rgba(16,185,129,0.25)]">
        Trusted Indian Sources
      </div>
    </div>

    {/* Heading */}
    <h1 className="text-3xl sm:text-4xl font-extrabold text-[#17153B] tracking-tight mb-2">
    ...
    <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
      ...
      economy, markets, and society - all powered by public sources.
    </p>

    {/* Compact search directly below */}
    <div className="flex justify-center mt-6 sm:mt-8">
      <div className="relative w-full max-w-lg">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-white/70 
    ...
    {/* Subtle divider line */}
    <div className="mt-10 mx-auto w-11/12 h-px bg-gradient-to-r from-transparent via-indigo-200/50 to-transparent"></div>
  </section>
